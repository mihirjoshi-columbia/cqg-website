        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-16 sm:py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="event-card max-w-[640px]" style={{ "--card-border": "var(--lime)" } as React.CSSProperties}>
                        <div className="event-card-body">
                            ...
                            <Link href="/competition" className="font-semibold text-sky-deep text-sm">
                                Learn more &rarr;
                            </Link>
                        </div>
                    </div>
